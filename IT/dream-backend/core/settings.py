...
SECRET_KEY = 'django-insecure-vyw5(_3mg)v%nw3)sg=ri8#6l&!-m+%fb%0n88gz$(c$@y(5&&'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # add her custom template dir
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# cors setup, here we can specify the allowed origins
...
# jtw token configuration
# more on the settings: https://django-rest-framework-simplejwt.readthedocs.io/en/latest/settings.html
SIMPLE_JWT = {
